Shader "Unlit/WireframeQuad"
{
    Properties
    {
        ...
        _WireframeAliasing("Wireframe width", float) = 1.5
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                float alpha = 1 - step(0.5, min(aliased.x, min(aliased.y, aliased.z)));                // Set to our backwards facing wireframe colour.
        ...
        Pass
        {
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                float3 aliased = smoothstep(float3(0.0, 0.0, 0.0), unitWidth * _WireframeAliasing, i.barycentric);
                // Use the coordinate closest to the edge.
                float alpha = 1 - step(0.5, min(aliased.x, min(aliased.y, aliased.z)));
